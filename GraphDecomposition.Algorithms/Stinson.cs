...
namespace GraphDecomposition.Algorithms 
{
    public class Stinson : IDecompositionAlgorithm
    {
        ...
        /// </summary>
        /// <param name="v">Number of vertices ina graph</param>
        ...
        /// <returns>STS(v) generated by the algorithm</returns>
        private SteinerTripleSystem ConstructBlocks(int v, int[,] Other)
        {
            SteinerTripleSystem sts = new SteinerTripleSystem(b);
        ...
        /// <param name="v">Number of vertices</param>
        /// <returns>STS(v) generated by the algorithm</returns>
        private SteinerTripleSystem StinsonsAlgorithm(int v)
        {
            NumBlocks = 0;
            Initialize(v);
           ...
           SteinerTripleSystem sts = ConstructBlocks(v, Other);
